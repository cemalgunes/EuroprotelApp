...
import Moment, { isDate, ISO_8601 } from 'moment';   // Tarih formatı
...
import { createStackNavigator } from 'react-navigation-stack';  // Yeni form açma kütüphanesi eklendi
  ...
  class  FetchForecast extends React.Component {
    ...
    constructor(props){
      ...
      this.state ={  // Değişken tanımlamaları..
        ...
        address:'http://176.236.39.34:19000/api/Forecast/'+Moment(adate).format('YYYY-MM-DD'),// Link uzantısı verildi..
      ...
      <KeyboardAwareScrollView>
        ...
        <View style={{flex: 1, paddingTop:20,backgroundColor:"#abaeb5"}}>
          <View style={{ flex: 1, alignItems: 'baseline', justifyContent: 'center'}}>
            ...
            <Text style={{fontWeight: 'bold',fontSize:20,  color:"#ffffff",textAlign: "center" }}> ÇEŞME ILICA HOTEL </Text>
          ...
          <View>
            ...
            dateInput: {
              ...
              onDateChange={(date) => {
                this.setState(
                  {address: 'http://176.236.39.34:19000/api/Forecast/'+Moment(date).format('YYYY-MM-DD'),
                  date : date
                }); 
              }}
            />
...
// HOTEL STATÜ CLASSI----------
    ...
    class FetchHotel extends React.Component {
      ...
      _refresh=()=> {
          ...
          this.state ={ 
            isLoading: true,
            address:'http://176.236.39.34:19000/api/HotelStatus/',
            showResim:true
            };
        }    
        componentDidMount(){   
            ...
            <KeyboardAwareScrollView>
                ...
                <View style={{flex: 1, paddingTop:20,backgroundColor:"#abaeb5"}}>
                  <View style={{ flex: 1, alignItems: 'baseline', justifyContent: 'center'}}>
                    <Image source={require('./assets/footer.png')} style={{width: 375,height:115,borderWidth:1,borderColor:'#abaeb5'}}/></View>
                    <View style={{backgroundColor:"#595B67"}}>
                    <Text style={{fontWeight: 'bold',fontSize:20,  color:'white',textAlign:"center",}}> ÇEŞME ILICA HOTEL</Text>
                    </View>
        ...
        class FetchRevenue extends React.Component {
          ...
          static navigationOptions = {
            ...
            //  this.onPress = this.onPress.bind(this);
              ...
              this.state ={  // Değişken tanımlamaları..
                isLoading: true, 
                address:'http://176.236.39.34:19000/api/Revenue/'+Moment(date1).format('YYYY-MM-DD')+'/'+Moment(date2).format('YYYY-MM-DD'),  // Link uzantısı verildi..
                  ...
                  <View>
                      ...
                      this.setState(
                        {
                          ...
                          address: 'http://176.236.39.34:19000/api/Revenue/'+Moment(date).format('YYYY-MM-DD')+'/'+Moment(this.state.date2).format('YYYY-MM-DD'),
                          date1 : date,  
                        });
                      }}
                    />
                    ...
                    <DatePicker    style={{width: 150}}
                     ...
                     this.setState(                       
                        {
                          totalPrice:this.state.totalPrice-this.setState.totalPrice,
                          address: 'http://176.236.39.34:19000/api/Revenue/'+Moment(this.state.date1).format('YYYY-MM-DD')+'/'+Moment(date).format('YYYY-MM-DD'),
                          date2 : date,
                        });
                      }}
                    />                         
...
// BOARD STATÜ CLASSI----
  ...
  class FetchBoard extends React.Component {
        ...
        _refresh=()=> {
            ...
            this.state ={ 
              isLoading: true,
              address:'http://176.236.39.34:19000/api/BoardStatus/',
              showResim:true
              };
          }          
          componentDidMount(){   
...
//INHOUSE CLASSI --------------
        ...
        class FetchInhouse extends React.Component {
          ...
          constructor(props){
              ...
              this.state ={ 
                isLoading: true,
                address:'http://176.236.39.34:19000/api/InHouse',
                query : '',  
                dataSource: [],  
                dataBackup: [],
                isOdaNo:'',
